        ...
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Agregar un doctor</h5>
                ...
                <div class="modal-body">
                    <form method="POST" id="altaForm" enctype="multipart/form-data">
                        <div class="form-group pt-2">
                            <label for="categoriaAdd">Nombre de Usuario</label>
                            <input type="text" class="form-control" id="categoriaAdd" name="categoriaAdd" placeholder="Nombre de Usuario">
                        </div>    

                        <div class="form-group">
                            <label for="imagenAdd">Contraseña</label>
                            <input type="text" class="form-control" id="imagenAdd" name="imagenAdd" placeholder="Contraseña">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="imagenAdd">Apellido Paterno</label>
                            <input type="text" class="form-control" id="imagenAdd" name="imagenAdd" placeholder="Apellido Paterno">
                        </div>

                        <div class="form-group">
                            <label for="imagenAdd">Apellido Materno</label>
                            <input type="text" class="form-control" id="imagenAdd" name="imagenAdd" placeholder="Apellido Materno">
                        </div>            

                        <div class="form-group">
                            <label for="imagenAdd">Teléfono</label>
                            <input type="text" class="form-control" id="imagenAdd" name="imagenAdd" placeholder="Telèfono">
                        </div>                        
                        <hr>
