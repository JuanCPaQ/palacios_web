        ...
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Agregar un consultorio</h5>
                ...
                <div class="modal-body">
                    <form method="POST" id="altaForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="imagenAdd">Dirección</label>
                            <input type="text" class="form-control" id="imagenAdd" name="imagenAdd" placeholder="Dirección">
                        </div>
                        <hr>
